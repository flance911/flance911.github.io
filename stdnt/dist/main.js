...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Geometric)\n/* harmony export */ });\n/* harmony import */ var _entity_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./entity.js */ \"./src/engine/entity.js\");\n\n\nclass Geometric extends _entity_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\n\n    constructor() {\n        super();\n    }\n\n}\n\n//# sourceURL=webpack://student/./src/engine/geometric.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Item)\n/* harmony export */ });\n/* harmony import */ var _engine_geometric__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../engine/geometric */ \"./src/engine/geometric.js\");\n\r\n// import Rectangle from '../engine/rectangle.js';\r\n// import Image from '../engine/image.js';\r\n// import Thebutton from '../engine/thebutton.js';\r\n\r\nclass Item extends _engine_geometric__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\r\n\r\n    handler = ()=>{};\r\n\r\n    params;\r\n    r = 10;\r\n    border = 5;\r\n    fillColor = 'rgba(30, 30, 30, 1)';\r\n    strokeColor = 'darkorange';\r\n\r\n    back;\r\n    image;\r\n\r\n    constructor(params) {\r\n        super(params);\r\n\r\n        this.params = params;\r\n\r\n\r\n    }\r\n\r\n    draw(ctx) {\r\n        ctx.beginPath();\r\n\r\n        ctx.lineWidth = 2;\r\n        ctx.fillStyle = this.fillColor;\r\n        ctx.strokeStyle = this.strokeColor;\r\n\r\n        // ctx.shadowBlur = 25;\r\n        // ctx.shadowColor = 'orange'; //\"#3BB048\";\r\n\r\n        if (this.r === 0) {\r\n            ctx.rect(this.params.x, this.params.y, this.params.width, this.params.height);\r\n        } else {\r\n            this.roundRect(ctx, this.params.x, this.params.y, this.params.width, this.params.height, this.r);\r\n        }\r\n\r\n        ctx.fill();\r\n        ctx.stroke();\r\n\r\n        ctx.shadowBlur = 0;\r\n        ctx.lineWidth = 1;\r\n\r\n        // ctx.shadowBlur = 30;\r\n        // ctx.shadowColor = 'gray'; //\"#3BB048\";\r\n\r\n        // const xx = this.params.x + this.params.width/2;\r\n        // const yy = this.params.y + this.params.height/2;\r\n        // const gradient = ctx.createRadialGradient(xx, yy, 5, xx, yy, 50);\r\n        // gradient.addColorStop(0, \"white\");\r\n        // gradient.addColorStop(1, \"rgba(0,0,0,0)\");\r\n        // ctx.fillStyle = gradient;\r\n        // ctx.fillRect(this.params.x, this.params.y, this.params.width, this.params.height);\r\n\r\n        ctx.drawImage(this.params.image.getIt(),\r\n            this.params.x + 5, this.params.y + 5, \r\n            this.params.width - 10, this.params.height - 10);\r\n\r\n        ctx.closePath();\r\n\r\n    }\r\n\r\n    checkClick(data) {\r\n        if (data.x > this.params.x && data.x < this.params.x + this.params.width) {\r\n            if (data.y > this.params.y && data.y < this.params.y + this.params.height) {\r\n                this.getHandler()();\r\n            }\r\n        }\r\n    }\r\n\r\n    setHandler(handler) {\r\n        this.handler = handler;\r\n    }\r\n\r\n    getHandler() {\r\n        return this.handler;\r\n    }\r\n\r\n    // appendTo(scene) {\r\n\r\n    // }\r\n\r\n    // removeFrom(scene) {\r\n\r\n    // }\r\n\r\n}\n\n//# sourceURL=webpack://student/./src/game/item.js?");
